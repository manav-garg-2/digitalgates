...
\\
    \overline{\overline{f}} =\overline{(\overline{AB\overline{D}}). (\overline{B\overline{C}\overline{D}}).(\overline{A\overline{C}\overline{D}})} ....         ...by Using(\overline{X+Y+Z} = \overline{X.Y.Z}
